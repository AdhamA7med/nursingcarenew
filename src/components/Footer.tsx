  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-primary-900 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 left-20 w-24 h-24 bg-accent-500 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-12 items-start">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="text-center md:text-right">
              <div className="flex items-center justify-center md:justify-start space-x-3 space-x-reverse mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">رعاية تمريضية جديدة</h3>
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="text-center">
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="block w-full text-gray-300 hover:text-accent-400 transition-colors py-2 px-4 rounded-lg hover:bg-white/10"
                >
                  الرئيسية
                </button>
                <button 
            ...
            <div data-aos="fade-up" data-aos-delay="300" className="text-center md:text-left">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center md:justify-start space-x-3 space-x-reverse">
                  ...
                  <span className="text-gray-300" dir="ltr">01203888230</span>
                </div>
                <div className="flex items-center justify-center md:justify-start space-x-3 space-x-reverse">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-3xl border border-white/20">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                <div className="flex items-center space-x-3 space-x-reverse">
                  <div className="bg-accent-500 w-12 h-12 rounded-full flex items-center justify-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <p className="text-gray-400 text-center md:text-left">
              ...
              <a 
                ...
                className="text-accent-400 hover:text-accent-300 transition-colors font-semibold hover:underline"
              >
                أدهم أحمد
              </a>
            </p>
        ...
        <div className="pb-8 flex justify-center space-x-6 space-x-reverse" data-aos="fade-up" data-aos-delay="600">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-green-500 w-14 h-14 rounded-full flex items-center justify-center hover:bg-green-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl group"
          >
            <i className="fab fa-whatsapp text-xl text-white group-hover:animate-bounce"></i>
          </a>
          <a 
            href="tel:01203888230"
            className="bg-primary w-14 h-14 rounded-full flex items-center justify-center hover:bg-primary-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl group"
          >
